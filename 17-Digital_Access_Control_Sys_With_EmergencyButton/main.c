...
/* include the libraries which used in our application */
#include "STD_TYPES.h"
#include "BIT_MATH.h"
#include "defines.h"
...
int main(void)
{
	...
	/* this function is used to initiate the system PORT, CLCD , SSD_En Off at the first
	 * to save power , and initiate EXTI (INT0) */
	DACS_voidInitSys(&SSD_t);

	/* ISR ====> Emergency_Action */
	EXTI_u8SetCallBack(EXTI_u8INT0,&Emergency_Action);
